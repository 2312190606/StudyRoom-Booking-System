...
const menuItems = [
  { name: '仪表盘', path: '/admin', exact: true, icon: 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z' },
      ...
      <header class="h-[80px] bg-[#0E121E] border-b border-[#1C2136] flex items-center justify-between px-10 shrink-0">
        ...
        <div class="flex items-center gap-6">
          <button class="text-gray-400 hover:text-white transition relative">
            ...
            <div class="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-red-500 rounded-full border-[2.5px] border-[#0E121E]"></div>
          </button>
