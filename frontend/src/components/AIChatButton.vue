...
<template>
  <!-- Floating Button -->
  <button
    class="fixed bottom-6 left-6 w-14 h-14 rounded-full bg-gradient-to-br from-[#667eea] to-[#764ba2] shadow-lg shadow-indigo-300 flex items-center justify-center hover:scale-110 transition-transform z-50"
    @click="showChat = true"
  >
  ...
  <Popup
    ...
    style="width: 90%; max-width: 400px; height: 70%; overflow: hidden;"
  >
